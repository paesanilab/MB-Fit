...
size_t read_connectivity(const char*, std::vector<int *>&, std::vector<int *>&, 
...
size_t read_molinfo(const char*, std::vector<double>&, 
                    std::vector<double>&, std::vector<int>&); 

size_t read_molinfo(const char*, std::vector<double>&, 
                    std::vector<double>&, std::vector<double>&, std::vector<int>&); 

size_t read_dispersion(const char*, std::vector<int>&, 
                    std::vector<int>&, std::vector<double>&); 

void print_xyz(std::ostream&, std::vector<std::string>,
	       const double*, std::string comment = "");

inline xyz_frame::xyz_frame()
: natm(0), xyz(0), E(0), Ebind(0), at_name(0)//, e1b(0)
{
}
