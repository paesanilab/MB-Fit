...
import json
import mbdecomp, molecule
from molecule_parser import xyz_to_molecules

sys.path.insert(0, os.path.dirname(os.path.abspath(__file__)) + "/../../")
import settings_reader
from exceptions import InvalidValueError, ParsingError, XYZFormatError, InconsistentValueError

# Config file, set by user, contains instructions for operation
settings = settings_reader.SettingsReader("driver_settings.ini")
