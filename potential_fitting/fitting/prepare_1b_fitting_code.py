...
def prepare_1b_fitting_code(settings, molecule_in, in_path, poly_path, poly_order, fit_path):
    ...
    os.system("python3 " + os.path.dirname(os.path.abspath(__file__)) + "/../../codes/1b-codes/get-1b-fit.py " + in_path + " " + fit_path + "/poly-direct.cpp " + settings + " " + str(poly_order))

    # restore settings
    os.system("mv " + settings + ".tmp " + settings)

    # copy the template files
    os.system("cp " + os.path.dirname(os.path.abspath(__file__)) + "/../../codes/1b-codes/template/* " + fit_path)
