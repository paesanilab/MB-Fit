...
def generate_1b_configurations(settings_path, geo, normal_modes, config_path):
    """
    ...
    configurations.generate_1b_configurations(settings_path, geo, normal_modes, config_path)
