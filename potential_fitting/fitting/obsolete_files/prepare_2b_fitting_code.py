...
def prepare_2b_fitting_code(settings_path, config_path, in_path, poly_path, poly_order, fit_path):
    ...
    os.system("python3 " + os.path.dirname(os.path.abspath(__file__)) + "/../../codes/2b-codes/get_2b_codes.py " + settings_path + " " + config_path + " " + fit_path + "/poly-direct.cpp " + str(poly_order) + " " + in_path)

    # restore settings
    os.system("mv " + config_path + ".tmp " + config_path)

    # copy the template files
    os.system("cp " + os.path.dirname(os.path.abspath(__file__)) + "/../../codes/2b-codes/template/* " + fit_path)
