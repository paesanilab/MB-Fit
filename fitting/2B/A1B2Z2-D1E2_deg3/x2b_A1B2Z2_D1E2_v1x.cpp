...
void error(int kode) {
    ...
    std::cerr << " ** Fatal Error in x2b_A1B2Z2_D1E2_v1x::load_netcdf() ** :" 
...
double x2b_A1B2Z2_D1E2_v1x::eval(const double* mon1, const double* mon2 ) const
{
    ...
    const double* D_1_b= xcrd + 9;
    const double* E_1_b= xcrd + 12;
    const double* E_2_b= xcrd + 15;
...
double x2b_A1B2Z2_D1E2_v1x::eval(const double* mon1, const double* mon2, 
                double * grd1, double * grd2) const
{
    ...
    double* D_1_b_g = xgrd + 9;
    double* E_1_b_g = xgrd + 12;
    double* E_2_b_g = xgrd + 15;
    ...
    vr[3].grads(g[3], D_1_b_g, E_1_b_g, D_1_b, E_1_b);
    vr[4].grads(g[4], D_1_b_g, E_2_b_g, D_1_b, E_2_b);
    vr[5].grads(g[5], E_1_b_g, E_2_b_g, E_1_b, E_2_b);

    vr[6].grads(g[6], A_1_a_g, D_1_b_g, A_1_a, D_1_b);
    vr[7].grads(g[7], A_1_a_g, E_1_b_g, A_1_a, E_1_b);
    vr[8].grads(g[8], A_1_a_g, E_2_b_g, A_1_a, E_2_b);

    vr[9].grads(g[9], B_1_a_g, D_1_b_g, B_1_a, D_1_b);
    vr[10].grads(g[10], B_1_a_g, E_1_b_g, B_1_a, E_1_b);
    vr[11].grads(g[11], B_1_a_g, E_2_b_g, B_1_a, E_2_b);

    vr[12].grads(g[12], B_2_a_g, D_1_b_g, B_2_a, D_1_b);
    vr[13].grads(g[13], B_2_a_g, E_1_b_g, B_2_a, E_1_b);
    vr[14].grads(g[14], B_2_a_g, E_2_b_g, B_2_a, E_2_b);

    vr[15].grads(g[15], Z_1_a_g, D_1_b_g, Z_1_a, D_1_b);
    vr[16].grads(g[16], Z_1_a_g, E_1_b_g, Z_1_a, E_1_b);
    vr[17].grads(g[17], Z_1_a_g, E_2_b_g, Z_1_a, E_2_b);

    vr[18].grads(g[18], Z_2_a_g, D_1_b_g, Z_2_a, D_1_b);
    vr[19].grads(g[19], Z_2_a_g, E_1_b_g, Z_2_a, E_1_b);
    vr[20].grads(g[20], Z_2_a_g, E_2_b_g, Z_2_a, E_2_b);
...
double x2b_A1B2Z2_D1E2_v1x::operator()(const double crd[18],
                            double grd[18]) const
{
