...
double poly_model::eval_direct(const double a[50], const double x[6])
{
    ...
    p[3] = x[1]*x[5] + x[0]*x[3] + x[0]*x[4] + x[2]*x[5] + x[1]*x[3] + x[2]*x[4];
    ...
    p[11] = x[0]*x[0]*x[1] + x[0]*x[0]*x[2] + x[1]*x[2]*x[2] + x[0]*x[2]*x[2] + x[0]*x[1]*x[1] + x[1]*x[1]*x[2];
    ...
    p[25] = x[0]*x[2]*x[3]*x[5] + x[1]*x[2]*x[3]*x[4] + x[0]*x[1]*x[4]*x[5];
    ...
    p[31] = x[0]*x[2]*x[4]*x[5] + x[0]*x[1]*x[3]*x[5] + x[0]*x[1]*x[3]*x[4] + x[0]*x[2]*x[3]*x[4] + x[1]*x[2]*x[4]*x[5] + x[1]*x[2]*x[3]*x[5];
    ...
    p[36] = x[1]*x[4]*x[4]*x[5] + x[2]*x[3]*x[3]*x[4] + x[0]*x[4]*x[5]*x[5] + x[2]*x[3]*x[3]*x[5] + x[1]*x[3]*x[4]*x[4] + x[0]*x[3]*x[5]*x[5];
    p[37] = x[3]*x[3]*x[4]*x[5] + x[3]*x[4]*x[4]*x[5] + x[3]*x[4]*x[5]*x[5];
    p[38] = x[0]*x[3]*x[3]*x[5] + x[0]*x[4]*x[4]*x[5] + x[2]*x[3]*x[5]*x[5] + x[1]*x[4]*x[5]*x[5] + x[1]*x[3]*x[3]*x[4] + x[2]*x[3]*x[4]*x[4];
    ...
    p[45] = x[2]*x[2]*x[2]*x[4] + x[1]*x[1]*x[1]*x[5] + x[1]*x[1]*x[1]*x[3] + x[2]*x[2]*x[2]*x[5] + x[0]*x[0]*x[0]*x[4] + x[0]*x[0]*x[0]*x[3];
