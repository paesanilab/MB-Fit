...
class QchemCalculator(Calculator):
    ...
    def find_energy_in_energy_calculation_output_file(self, qchem_out_path):
        ...
        raise LibraryCallError("qchem", "energy calculation", "output file is of incorrect format")
    ...
    def find_optimized_geometry_and_energy_in_optimization_output_file(self, qchem_out_path):
        ...
        raise LibraryCallError("qchem", "optimze", "output file is of incorrect format")
